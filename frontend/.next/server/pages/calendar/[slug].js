...
/* harmony import */ var _components_user_avatar__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(3167);
...
const getGames = (nextMonth = 0) => {
  ...
  return (0,_lib_api__WEBPACK_IMPORTED_MODULE_8__/* .ajaxAPI */ .EK)('/games', {
    dates: `${start},${end}`
  });
};
...
const Calendar = ({
  ...
  const init = async () => {
    const currentDay = moment__WEBPACK_IMPORTED_MODULE_4___default()().day(); // getDaysGames(0, currentDay)
  };
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
      className: "fixed w-full justify-between flex px-3 py-2 bg-[#201F25]",
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        className: "flex items-center",
        children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("a", {
          href: `/member/${slug}`,
          children: /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_user_avatar__WEBPACK_IMPORTED_MODULE_7__/* .default */ .Z, {
            user: user,
            size: "md",
            className: "mr-2"
          })
      ...
      }), year && month && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        className: "flex flex-end items-end text-white text-sm",
...
async function getServerSideProps(ctx) {
  ...
  const [user] = await (0,_lib_api__WEBPACK_IMPORTED_MODULE_8__/* .fetchAPI */ .Io)(`/users?filters[email][$eq]=${slug}&populate=avatar`);
  return {
    props: {
      slug,
      user
...
var __webpack_exports__ = __webpack_require__.X(0, [883,167], function() { return __webpack_exec__(3046); });
